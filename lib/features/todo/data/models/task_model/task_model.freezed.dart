...
mixin _$TaskModel {
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description,
      completed, priority, category, dateTime);
...
extension TaskModelPatterns on TaskModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String title, String description, bool completed,
            int priority, String? category, DateTime? dateTime)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TaskModel() when $default != null:
        return $default(_that.id, _that.title, _that.description,
            _that.completed, _that.priority, _that.category, _that.dateTime);
      case _:
        return orElse();
    }
  }
